...
export default function SoundCloudWidget (){
    return (
        <div>
            ...
            <div style={style1}>
                <a href="https://soundcloud.com/boxofcatsmusic" title="Box Of Cats"  style={style2}>Box Of Cats</a>
                 · 
                <a href="https://soundcloud.com/boxofcatsmusic/bluri-daaayyy-boc130" title="Bluri - Daaayyy (BOC130)"  style={style2}>
